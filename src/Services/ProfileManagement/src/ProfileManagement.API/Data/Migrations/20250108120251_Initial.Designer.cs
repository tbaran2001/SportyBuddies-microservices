...
namespace ProfileManagement.API.Data.Migrations
{
    ...
    [Migration("20250108120251_Initial")]
            ...
            modelBuilder.Entity("ProfileManagement.API.Profiles.Models.Profile", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Description", "ProfileManagement.API.Profiles.Models.Profile.Description#ProfileDescription", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Name", "ProfileManagement.API.Profiles.Models.Profile.Name#ProfileName", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Preferences", "ProfileManagement.API.Profiles.Models.Profile.Preferences#Preferences", b1 =>
                        {
                            b1.IsRequired();
