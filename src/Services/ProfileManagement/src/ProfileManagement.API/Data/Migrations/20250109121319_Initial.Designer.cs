...
namespace ProfileManagement.API.Data.Migrations
{
    ...
    [Migration("20250109121319_Initial")]
            ...
            modelBuilder.Entity("ProfileManagement.API.Profiles.Models.Profile", b =>
                {
                    ...
                    b.OwnsOne("ProfileManagement.API.Profiles.ValueObjects.ProfileDescription", "Description", b1 =>
                        {
                            b1.Property<Guid>("ProfileId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("ProfileManagement.API.Profiles.ValueObjects.ProfileName", "Name", b1 =>
                        {
                            b1.Property<Guid>("ProfileId")
                                .HasColumnType("uniqueidentifier");
